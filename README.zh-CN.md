<h1 align="center"><a href="https://github.com/zhangpengboy/vite-vue-js-vant-template" target="_blank">Vite 3 🚀 - Vue 3  Vant4 Template</a></h1>
...
<p align='center'>
  <b>Vite3</b> + <b>Vue3</b> + <b>JavaScript</b> + <b>Vue Router</b> + <b>Pinia</b> + <b>Vant4</b> + <b>Less</b> + <b>Axios</b> + <b>ESLint + Stylelint + Prettier</b>
</p>
...
+ 💻 [Vant4](https://vant-ui.github.io/vant/v4/#/zh-CN) - Vant 适配移动端的组件库
...
> Vite3 Vue3 JavaScript Vant4 Template 需要 Node 版本 >= 14.18

### GitHub 模板

[使用这个模板创建仓库](https://github.com/zhangpengboy/vite-vue-js-vant-template).
...
```bash
# 克隆
git clone https://github.com/zhangpengboy/vite-vue-js-vant-template
